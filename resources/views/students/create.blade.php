    ...
    <div class="col-lg-7">
        <div class="card">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 text-primary"><i class="bi bi-person-plus me-2"></i>Add New Student</h6>
            </div>
                ...
                <form action="{{ route('students.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="stu_firstname" class="form-control" value="{{ old('stu_firstname') }}" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Last Name</label>
                            <input type="text" name="stu_lastname" class="form-control" value="{{ old('stu_lastname') }}" required>
                        </div>
                        <div class="col-md-4">
